...
void SceneManager::RenderScene()
{
...

	{
		...
		m_pShaderManager->setVec3Value("lightSources[0].position", glm::vec3(2.0f, 6.0f, 2.0f));
		...
		m_pShaderManager->setVec3Value("lightSources[1].position", glm::vec3(-2.0f, 6.0f, -2.0f));
		m_pShaderManager->setVec3Value("lightSources[1].ambientColor", glm::vec3(0.35f, 0.35f, 0.35f));
		m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", glm::vec3(0.8f, 0.8f, 0.9f));
		...
		m_pShaderManager->setVec3Value("lightSources[2].ambientColor", glm::vec3(0.30f, 0.30f, 0.30f));
		m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", glm::vec3(0.9f, 0.9f, 0.9f));
	...
	// M4: tiled pavers texture on plane
	SetShaderTexture("pavers");
	SetTextureUVScale(8.0f, 8.0f);   // tiling = complex technique
	m_basicMeshes->DrawPlaneMesh();

	// reset UV so other objects don't inherit tiling
	SetTextureUVScale(1.0f, 1.0f);

	/******************************************************************/
// COMPLEX OBJECT - BASE (BOX)
	...
	// M4: wood texture on base of complex object
...
// COMPLEX OBJECT - TOP (CYLINDER)
	...
	// M4: metal texture on top of complex object
